...
export class FrogBase {
    constructor(parameters) {
        ...
        Object.defineProperty(this, "verifyOrigin", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: process.env.NODE_ENV === 'production'
        ...
        Object.defineProperty(this, "composerAction", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: (...parameters) => {
                ...
                if ('handler' in options) {
                    this.hono.get(parseHonoPath(path), ...middlewares, async (c) => {
                        const { aboutUrl, name, description, icon, imageUrl } = await options.handler(c);
                        return c.json({
                            aboutUrl,
                            action: {
                                type: 'post',
                ...
                this.hono.post(parseHonoPath(path), ...middlewares, async (c) => {
                    const { context } = getComposerActionContext({
                        context: await requestBodyToContext(c, {
                            hub: this.hub ||
                                (this.hubApiUrl ? { apiUrl: this.hubApiUrl } : undefined),
                            secret: this.secret,
        ...
        Object.defineProperty(this, "frame", {
            ...
            value: (...parameters) => {
                ...
                this.hono.use(parseHonoPath(path), ...middlewares, async (c) => {
                    ...
                    const { context, getState } = await getFrameContext({
                        context: await requestBodyToContext(c, {
                            hub: this.hub ||
                                (this.hubApiUrl ? { apiUrl: this.hubApiUrl } : undefined),
                            secret: this.secret,
                    ...
                    const imageUrl = await (async () => {
                        ...
                        if (isHandlerPresentOnImagePath)
                            return `${baseUrl + parsePath(image)}${context.status !== 'initial'
                                ? `?${toSearchParams({
                                    previousState,
                                    previousButtonValues: buttonValues,
                                }).toString()}`
        ...
        Object.defineProperty(this, "image", {
            ...
            value: (...parameters) => {
                ...
                this.hono.get(path, ...middlewares, async (c) => {
                    ...
                    const origin = this.origin ?? url.origin;
                    const assetsUrl = origin + parsePath(this.assetsPath);
                    const { context } = await getImageContext({
        ...
        const { assetsPath, basePath, browserLocation, dev, headers, honoOptions, hubApiUrl, hub, imageAspectRatio, imageOptions, initialState, origin, secret, title, ui, unstable_metaTags, verify, verifyOrigin, } = parameters;
        ...
        if (typeof verify !== 'undefined')
            this.verify = verify;
        if (typeof verifyOrigin !== 'undefined')
    ...
    route(path, frog) {
        ...
        if (!frog.ui)
            frog.ui = this.ui;
        if (typeof frog.verify === 'undefined')
